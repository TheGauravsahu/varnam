...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen flex bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 transition-colors duration-300">
      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-zinc-200/40 dark:border-zinc-800/40 bg-white dark:bg-zinc-900 shrink-0 p-6 space-y-8 h-screen sticky top-0">
        ...
        <div className="space-y-4 pt-6 border-t border-zinc-100 dark:border-zinc-800/40">
          ...
          <div className="flex items-center justify-between gap-2">
            <button 
              onClick={toggleTheme}
              className="flex-1 py-2 px-3 rounded-xl border border-zinc-200 dark:border-zinc-800 text-xs font-semibold hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-all flex items-center justify-center gap-1.5 focus:outline-none"
            >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="md:hidden flex items-center justify-between px-6 h-16 border-b border-zinc-200/40 dark:border-zinc-800/40 bg-white dark:bg-zinc-900 sticky top-0 z-40">
          ...
          <div className="flex items-center gap-2">
            <button 
              onClick={toggleTheme} 
              className="w-9 h-9 rounded-lg border border-zinc-250 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400 flex items-center justify-center focus:outline-none"
            >
              {theme === 'dark' ? <Sun className="w-4 h-4" /> : <Moon className="w-4 h-4" />}
            </button>
            <button 
              onClick={handleLogout} 
              className="w-9 h-9 rounded-lg border border-red-500/20 text-red-500 flex items-center justify-center focus:outline-none"
            >
              <LogOut className="w-4 h-4" />
            </button>
          </div>
